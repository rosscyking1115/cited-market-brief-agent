        ...
        <section className="flex flex-col gap-2 border-b border-hairline pb-5 sm:flex-row sm:items-end sm:justify-between">
          <div>
            ...
            <p className="reader-body mt-2 max-w-3xl text-[14px] leading-relaxed text-neutral-70">
              ...
              In the Traditional Chinese and Korean editions, structure and citation problems are recorded
              automatically but not blocked, and the wording itself is not evaluated; review and approval stay tied to
